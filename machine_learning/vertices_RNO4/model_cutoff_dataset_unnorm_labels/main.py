...
train_album = AlbumDataset(train_album_path, transform=None, target_transform=target_transform, normalize_labels=True)
test_album = AlbumDataset(test_album_path, transform=None, target_transform=target_transform, normalize_labels=True)
...
# Initialize model
models = RNO_four_1_1_1s_dropout_noleak(input_shape=1,
