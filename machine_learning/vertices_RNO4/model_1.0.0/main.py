...
train_album_path = '/data/i3store/users/ssued/albums/RNO_album_10_12_2025/album_RNO4.hdf5_train.hdf5'
test_album_path = '/data/i3store/users/ssued/albums/RNO_album_10_12_2025/album_RNO4.hdf5_test.hdf5'

# Load Datasets
# album = AlbumDataset(album_path, transform=None, target_transform=None)
train_album = AlbumDataset(train_album_path, transform=None, target_transform=None)
test_album = AlbumDataset(test_album_path, transform=None, target_transform=None)
...
# Initialize model
models = RNO_four_1_0_0(input_shape=1,
                          hidden_units=20, 
                          output_shape=3,
