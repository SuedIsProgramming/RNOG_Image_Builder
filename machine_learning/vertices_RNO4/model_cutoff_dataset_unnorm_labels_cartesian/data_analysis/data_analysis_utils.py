...
from utils_dir.dataset import Dataset
...
class ModelEval:
    ...
    def plot_true_reco(self, custom_title: str = None, spherical: bool = False):
            ...
            if not spherical:
                ...
                plot_component(axes.T[0], x_true, x_guess, 'X', 'tab:orange', add_label=True)
                
                # Plot y (No label)
                plot_component(axes.T[1], y_true, y_guess, 'Y', 'tab:green', add_label=False)
                
                # Plot z (No label)
                plot_component(axes.T[2], z_true, z_guess, 'Z', 'tab:blue', add_label=False)
            ...
            if spherical:
                ...
                plot_component(axes.T[0], r_true, r_guess, 'R', 'tab:orange', add_label=True)
    ...
    def plot_progression_true_reco(self, spherical: bool = False):
        """ 
        ...
        for checkpoint_file in files:
            ...
            # Plot
            self.plot_true_reco(custom_title=f'Progression: {checkpoint_file}', spherical= spherical)
