...
train_album_path = '/data/i3store/users/ssued/albums/RNO_album_10_13_2025_spherical_debug/album_RNO4.hdf5'
test_album_path = '/data/i3store/users/ssued/albums/RNO_album_10_13_2025_spherical_debug/album_RNO4.hdf5'
...
# Initialize model
models = RNO_four_1_1_1s_batch_norm(input_shape=1,
                          hidden_units=20, 
                          output_shape=3,
